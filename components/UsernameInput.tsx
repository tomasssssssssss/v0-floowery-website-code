          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-3 w-full rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#744AEC] focus:border-transparent"
                value={username}
            ...
            <Button
              type="submit"
              className="w-full bg-[#744AEC] hover:bg-[#5A35C3] text-white py-3 rounded-lg transition-colors"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
