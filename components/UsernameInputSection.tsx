...
export default function UsernameInputSection({ onSubmit }: UsernameInputSectionProps) {
    ...
    <div className="min-h-screen bg-[#F0F0F0] flex items-center justify-center px-4">
      <Card className="w-full max-w-md border-0 shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-[#160C29]">Track Your Instagram Growth</CardTitle>
          <CardDescription className="text-[#59CCB1]">
        ...
        <CardContent>
          ...
          <div className="mt-8 bg-[#160C29]/10 p-4 rounded-lg">
            <h3 className="font-medium text-[#59CCB1] mb-2">Why track your Instagram growth?</h3>
            <ul className="space-y-2 text-sm text-[#59CCB1]">
