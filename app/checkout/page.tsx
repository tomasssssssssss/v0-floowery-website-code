              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <label
                      htmlFor="monthly"
                      className={`block border-2 rounded-xl p-5 text-center cursor-pointer transition-all duration-200 hover:shadow-md ${
                        paymentType === "monthly"
                          ? "border-[#160C29] bg-[#160C29] bg-opacity-5 shadow"
                  ...
                  <div>
                    ...
                    <label
                      htmlFor="yearly"
                      className={`block border-2 rounded-xl p-5 text-center cursor-pointer transition-all duration-200 hover:shadow-md relative ${
                        paymentType === "yearly"
                          ? "border-[#160C29] bg-[#160C29] bg-opacity-5 shadow"
                          : "border-[#160C29] border-opacity-10 hover:border-opacity-30"
                      }`}
              ...
              <div className="p-6 space-y-4">
                {servicePackages.map((pkg) => (
                  <div
                    ...
                    className={`
                      border-2 rounded-xl p-5 cursor-pointer transition-all duration-200 relative hover:shadow-md
                      ${
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border-2 border-[#160C29] border-opacity-20 rounded-lg focus:outline-none focus:ring-2 ring-[#59CCB1] focus:border-transparent transition-all"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-10 px-4 py-3 border-2 border-[#160C29] border-opacity-20 rounded-lg focus:outline-none focus:ring-2 ring-[#59CCB1] focus:border-transparent transition-all"
          ...
          <div className="md:col-span-1">
            <div className="bg-[#F0F0F0] rounded-xl shadow-lg overflow-hidden border border-[#160C29] border-opacity-10 sticky top-4">
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <label
                        htmlFor="credit-card"
                        className={`block border-2 rounded-lg p-3 text-center cursor-pointer transition-all ${
                          formData.paymentMethod === "credit-card"
                            ? "border-[#160C29] bg-[#160C29] bg-opacity-5"
                            : "border-[#160C29] border-opacity-10 hover:border-opacity-30"
                        }`}
                      >
                ...
                <Link
                  href={`/checkout/success?plan=${selectedPackage?.id}&type=${paymentType}`}
